...
void MPU401_Init(void far* qpientry,Bit8u* sysexbuf,Bitu maxsysexsize,Bitu sbport,Bitu irq,Bitu mpuport,Bitu serialport,OutputMode outputmode,bool delaysysex,bool fakeallnotesoff)
{
	...
	/* Initialise MIDI handler */
        MIDI_Init(sysexbuf,maxsysexsize,mpuport,sbport,serialport,outputmode,delaysysex,fakeallnotesoff);
